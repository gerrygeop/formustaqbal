			...
			<section class="col-span-1">
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
					...
					@forelse ($rooms as $room)
						<a href="{{ route('courses.modules.show', $room->module->id) }}"
							class="col-span-1 bg-white dark:bg-gray-800 overflow-hidden shadow-sm border border-transparent hover:border-slate-300 sm:rounded-lg transition duration-150">
