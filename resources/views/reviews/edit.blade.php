			...
			<div class="grid grid-cols-1 lg:grid-cols-4">
				...
				<div class="col-span-1 lg:col-span-3 bg-white">
					<div class="max-w-5xl mx-auto">
						<div class="py-8 px-4 lg:px-4 mb-20">
							...
							<form action="{{ route('quiz.review.update', $userResponses) }}" method="POST" class="py-6">
								...
								<div class="grid grid-cols-1 divide-y">
									@foreach (json_decode($userResponses->responses) as $response)
										<div class="py-6 flex flex-col lg:flex-row items-start space-y-4 lg:space-y-0 lg:space-x-3">
											<div class="px-2.5 py-0.5 border bg-gray-50 flex-shrink-0">
