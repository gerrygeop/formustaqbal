<x-app-layout>
	<div class="max-w-6xl mx-auto">
		<div class="grid grid-cols-1 lg:grid-cols-4 gap-y-6 lg:gap-x-8 mb-16">
			...
			<div class="col-span-1 lg:col-span-3" x-data="{ currentTab: 1, activeTab: 'font-semibold text-gray-800 border-b-2 border-yellow-500', inactiveTab: 'text-gray-600 border-transparent' }">
				<div class="bg-white rounded-lg shadow">
					<div class="flex items-center border-b gap-x-6">
						<button class="py-4 px-6" :class="currentTab === 1 ? activeTab : inactiveTab" @click="currentTab = 1">
							Silabus
						</button>
						<div class="py-4 px-6" :class="currentTab === 2 ? activeTab : inactiveTab" @click="currentTab = 2">
							<button>Quiz/Exam</button>
						</div>
					</div>
