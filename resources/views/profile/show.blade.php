			...
			<div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg overflow-hidden">
				...
				<div class="px-4 sm:px-6">
					<dl class="divide-y divide-gray-100">
						...
						<div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
							<dt class="text-sm font-medium leading-6 text-gray-900 dark:text-white">Prodi</dt>
							<dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
						...
						<div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
							<dt class="text-sm font-medium leading-6 text-gray-900 dark:text-white">Local</dt>
							<dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
			...
			<div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg overflow-hidden">
				...
				<div class="px-4 sm:px-6">
					<dl class="divide-y divide-gray-100">
						...
						<div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
							<dt class="text-sm font-medium leading-6 text-gray-900 dark:text-white">Gender</dt>
							<dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
								{{ $user->profile->gender ?? '-' }}
							</dd>
						</div>
