<aside
	class="fixed hidden md:flex md:flex-col w-72 h-screen py-4 overflow-y-auto bg-white dark:bg-gray-800 border-r dark:border-gray-700/60">
	...
	<nav class="flex-1 flex flex-col justify-between mt-16 px-5">
		<div class="space-y-3 ">
			...
			<x-sidelink href="{{ route('courses.my') }}" active="{{ request()->routeIs('courses.my') }}">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
					<path
		...
		<div class="space-y-10">
			<x-sidelink href="{{ route('profile.edit') }}" active="{{ request()->routeIs('profile.edit') }}">
				{{-- <img src="{{ asset('shapes/ava.svg') }}" class="w-8 h-8" /> --}}
