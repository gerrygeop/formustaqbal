		...
		<div
			...
			<div class="w-full z-[55]">
				<div class="max-w-5xl mx-auto w-full">
					<div class="bg-white/50 backdrop-blur border border-b-4 rounded-xl shadow py-20 px-4 lg:px-0">
						<h2 class="font-semibold text-2xl lg:text-3xl text-center text-gray-800 dark:text-gray-50">
							Anda sudah mengambil Placement Test pada bahasa ini
						</h2>

						<div class="flex items-center justify-center w-full mt-14 px-6 md:px-0">
							<a href="/"
								class="text-xl font-semibold text-center text-white bg-yellow-500 rounded-lg border border-amber-500 w-96 py-2">Kembali</a>
						</div>
					</div>
				</div>
			</div>
